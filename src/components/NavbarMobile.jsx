...
function NavbarMobile() {
  ...
  return (
    ...
    <section className={`w-full flex flex-row justify-between items-center md:hidden bg-white dark:bg-gray-950 fixed top-0 z-10 ${isScrolled ? "flex-row shadow-lg bg-white px-8 py-4" : "flex flex-row py-4 px-8"}`}>
