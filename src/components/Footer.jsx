...
function Footer() {
  return (
    ...
    <footer className="h-0" id="footer">
        ...
        <div className="flex bg-transparent fixed origin-bottom-left bottom-6 left-6 items-center text-emerald-600 dark:text-emerald-300 -rotate-90 bg-white dark:bg-slate-950">
          <div className="flex bg-emerald-600 w-20 h-[1px]"></div>
            <p className="text-xs md:text-sm w-80 md:w-full text-center font-extralight md:font-normal">© Perú, Lima - Jose Sanchez. Derechos reservados.</p>
        </div>
